...
define('BETA_PROMOTION',   "http://beta.riign.cn/promotion?id=");//测试推广页单页面
...
define('BETA_PROMOTION_DB','mysql://beta_spread:beta2008beta@139.224.40.238:3306/beta_spread#utf8');//测试推广页DB
