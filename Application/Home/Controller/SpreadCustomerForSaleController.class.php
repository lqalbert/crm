...
class SpreadCustomerForSaleController extends CommonController{
    ...
    public function setQeuryCondition(){
        ...
        $this->M->join("left join department_basic as db1 on customers_basic.spread_id=db1.id")
                ...
                ->field("customers_basic.name,customers_basic.id,customers_basic.created_at,customers_basic.dis_time,customers_basic.type, CONCAT(db1.name,' - ',ui1.realname) as spread_name,db2.name as depart_name, gb.name as g_name ,ui2.realname as sale_name, ui1.mphone,ui1.qq,ui1.weixin");
    }
