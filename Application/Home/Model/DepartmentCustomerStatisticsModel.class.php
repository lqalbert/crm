...
class DepartmentCustomerStatisticsModel extends CustomerCountModel {
    ...
    */
    public function setTypeCount(){
        $sql = "select count(cb.id) as c , `type` , department_id from customers_basic as cb inner join user_info as ui on cb.salesman_id= ui.user_id group by ui.department_id";
        $re = M()->query($sql);
