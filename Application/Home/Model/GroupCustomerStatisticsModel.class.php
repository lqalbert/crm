...
class GroupCustomerStatisticsModel extends CustomerCountModel {
    ...
    */
    public function setTypeCount(){
        $sql = "select count(cb.id) as c , `type` , ui.group_id from customers_basic as cb inner join user_info as ui on cb.salesman_id= ui.user_id where ui.department_id=".$this->depart_id." group by ui.group_id";
        $re = M()->query($sql);
