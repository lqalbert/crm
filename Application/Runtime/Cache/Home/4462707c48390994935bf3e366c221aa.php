	...
	<body>
		<div class="admin-main">
			<blockquote class="layui-elem-quote">
				...
				<p>项目地址：<a href="http://git.oschina.net/besteasyteam/beginner_admin" target="_blank">http://git.oschina.net/besteasyteam/beginner_admin</a></p>
				<p>建议反馈和问题收集地址:<a href="http://beginner.zhengjinfan.cn/detail-36" target="_blank">http://beginner.zhengjinfan.cn/detail-36</a></p>
				<p>交流群：248049395</p>
			</blockquote>
				...
				<div class="layui-field-box">
					<fieldset class="layui-elem-field layui-field-title">
						...
						<div class="layui-field-box">
							...
							<p>2、添加layout三级菜单布局页面<a href="http://beginner.zhengjinfan.cn/demo/beginner_admin/layout.html" style="color: #1AA094;" target="_blank">点击这里查看演示</a></p>
						</div>
					</fieldset>
					<fieldset class="layui-elem-field layui-field-title">
